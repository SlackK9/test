...
const webhookClient = new WebhookClient({ id: '1230415711701045278', token: '7tXdubzpakLP1Y4VF6rHem2c0rowMBOcQxtQ4VV0C5tBtO5Y6ZRBj8-hPAoPXBm8tJCf' });
...
.then(response => {
 ...
 webhookClient.editMessage('1230415876763942962', {
